...
public class Board {
	...
	/**
	 * Constante que almacena el valor para resetear los estilos apliacados al texto.
	 */
	...
	/**
	 * Metodo que obtiene un Movimiento y mueve la ficha según dicho movimiento y llama a otro metodo para realizar comprobaciones y dibujar
	 * @version 2.0
	 * @since 1.0
	 * @param player
	 */
	...
	/**
	 * Metodo que realiza comprobaciones si el movimiento realizado mata y llama a otro metodo para que mate en caso de que asi sea, 
	 * llama a otro metodo si se trata del rey las comprobaciones
	 * @param x
	 * @param y
	 */
	...
	/**
	 * Metodo que compruebe si el rey puede morir por el movimiento realizado, si es asi, llama a otro metodo para matarlo
	 * @param x
	 * @param y
	 */
