...
public enum SquareType {
	...
	/**
	 * El enum Throne es la casilla central del tablero (unicode-Color fondo negro, unicode-Color negro).
	 */
	Throne("\u001B[40m", "\u001B[30m"){
	...
	/**
	 * El enum Corner son las casillas de las esquinas del tablero (unicode-Color fondo negro, unicode-Color negro).
	 */
	Corner("\u001B[40m", "\u001B[30m"){
	...
	/**
	 * El enum Normal son las casillas que no son ni las esquinas ni la casilla central (unicode-Color fondo verde, unicode-Color verde).
	 */
	Normal("\u001B[42m", "\u001B[32m"){
